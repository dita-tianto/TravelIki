...
// import Model.Layanan;
// import View.All_Panel.nDialog_Pemesanan;

public class nDialog_Pemesanan extends JFrame {
    private static nDialog_Pemesanan frame;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            nDialog_Pemesanan dl = new nDialog_Pemesanan();
            dl.initialize();
        });
    }
