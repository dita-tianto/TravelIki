...
import Controller.Purchase_details_cntrl;
...
public class Create_Purchase extends JPanel {
	...
	public Create_Purchase() {
		...
		JLabel lblCustomarName = new JLabel("Vendor Name :");
		...
		btnEnter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(pd_id == ex_pd_id){
				   ...
				   purchase.tocontroller(pd_name,qun,buy,sell);
		...
		vn = new JTextField();
		vn.setText("Vendor Name");
		vn.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
		        if (vn.getText().equals("Vendor Name")) {
		            vn.setText("");
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				new Purchase_master_contrl(date,vendor,tam,paid,due);
				
				new Purchase_details_cntrl();
				temp.load();
			}
		});
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					MessageFormat foot=new MessageFormat("this is header");
